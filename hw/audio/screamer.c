 ...
 *
 * Ported to modern QEMU APIs (10.x) for the Juke project.
 */
...
static void pmac_screamer_rx(DBDMA_io *io)
{
    ...
    /* Stop channel after updating with status to stop MacOS 9 freezing */
...
static const TypeInfo screamer_info_types[] = {
    {
        .name = TYPE_SCREAMER,
...
DEFINE_TYPES(screamer_info_types)
