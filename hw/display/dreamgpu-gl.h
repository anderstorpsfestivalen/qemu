...
bool dg_gl_engine_submit(DgGLEngine *engine, uint8_t *data, size_t bytes,
                           uint32_t sequence, uint32_t generation,
                           uint32_t primary_width, uint32_t primary_height,
                           uint32_t records);
void dg_gl_engine_reset(DgGLEngine *engine, uint32_t generation,
...
void dg_gl_engine_transfer_done(DgGLEngine *engine, uint32_t error,
                                 uint64_t cpu_epoch, uint64_t cpu_generation);
