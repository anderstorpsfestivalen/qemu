...
#ifndef JUKE_GPU_TRANSPORT_H
#define JUKE_GPU_TRANSPORT_H
...
#define JGPU_CPU_SLOT_BASE          96
#define JGPU_MAX_CPU_SLOTS          8
#define JGPU_MAX_CPU_BYTES          0x04000000
#define JGPU_KIND_HELLO             1
#define JGPU_KIND_FRAME             2
#define JGPU_KIND_RELEASE           3
#define JGPU_KIND_ERROR             4
#define JGPU_KIND_DRAWABLE          5
#define JGPU_KIND_CPU_DESKTOP       6
#define JGPU_KIND_DESKTOP_OP        7
#define JGPU_KIND_DESKTOP_REPLY     8
#define JGPU_KIND_RESOURCE_DROP     9
#define JGPU_KIND_RESET             10
#define JGPU_PLATFORM_MACOS         1
#define JGPU_PLATFORM_LINUX         2
#define JGPU_FLAG_TOP_LEFT          1
#define JGPU_FLAG_READY_FENCE        2
#define JGPU_FLAG_RETAIN_FOR_DESKTOP 4
#define JGPU_FORMAT_ARGB8888         0x34325241 /* DRM AR24, bytes BGRA */
...
#define JGPU_OFF_MAGIC              0
#define JGPU_OFF_VERSION            4
#define JGPU_OFF_KIND               8
#define JGPU_OFF_SIZE               12
#define JGPU_OFF_FLAGS              16
#define JGPU_OFF_WIDTH              20
#define JGPU_OFF_HEIGHT             24
#define JGPU_OFF_STRIDE             28
#define JGPU_OFF_FOURCC             32
#define JGPU_OFF_OFFSET             36
#define JGPU_OFF_SLOT               40
#define JGPU_OFF_CLIENT             44
#define JGPU_OFF_DRAWABLE           48
#define JGPU_OFF_EPOCH              56
#define JGPU_OFF_GENERATION         64
#define JGPU_OFF_MODIFIER           72
#define JGPU_OFF_DEVICE_UUID        80
 ...
 */
#define JGPU_HELLO_PLATFORM         16
#define JGPU_HELLO_MACH_SERVICE     24
#define JGPU_HELLO_MACH_SERVICE_LEN 56
#define JGPU_HELLO_RENDER_NODE      96
#define JGPU_HELLO_RENDER_NODE_LEN  32
 ...
 */
#define JGPU_CPU_SEED               1
#define JGPU_CPU_PATCH              2
#define JGPU_CPU_RETURN             3
#define JGPU_CPU_OFF_SUBTYPE        16
#define JGPU_CPU_OFF_ALLOCATION     72
#define JGPU_CPU_OFF_DST_X          80
#define JGPU_CPU_OFF_DST_Y          84
#define JGPU_CPU_OFF_LEGACY_EPOCH   88
#define JGPU_CPU_OFF_LEGACY_FRAME   96
 ...
 */
#define JGPU_DESKTOP_FILL           1
#define JGPU_DESKTOP_COPY           2
#define JGPU_DESKTOP_BLIT           3
#define JGPU_DESKTOP_READBACK       4
#define JGPU_DESKTOP_DISCARD        5
#define JGPU_DESKTOP_BLIT_RELEASE   1
#define JGPU_DESKTOP_OFF_OPCODE     16
#define JGPU_DESKTOP_OFF_DST_X      20
#define JGPU_DESKTOP_OFF_DST_Y      24
#define JGPU_DESKTOP_OFF_WIDTH      28
#define JGPU_DESKTOP_OFF_HEIGHT     32
#define JGPU_DESKTOP_OFF_SRC_X      36
#define JGPU_DESKTOP_OFF_SRC_Y      40
#define JGPU_DESKTOP_OFF_GPU_SLOT   52
#define JGPU_DESKTOP_OFF_GPU_EPOCH  72
#define JGPU_DESKTOP_OFF_GPU_FRAME  80
#define JGPU_DESKTOP_OFF_TOKEN      88
#define JGPU_DESKTOP_OFF_COLOR      96
#define JGPU_DESKTOP_OFF_FLAGS      100
